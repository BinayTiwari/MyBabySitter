  ...
  <div data-example-id="simple-responsive-table" class="bs-example"><div class="table-responsive"> 
	  <table class="table table-bordered"> 
		  ...
		  <tr> 
              ...
              <th>curContent<BR>curRedirectDate</th>
               <th>curRedirectMail<BR>curRemarks</th> 
		  ...
		  <tr> <th scope="row">321<BR>
              ...
              <td>i needed helsp with... <BR>26/5/18 12:55</td> 
              <td><input name="curRedirectMail" type="text" placeholder="curRedirectMail" class="form-control" /><BR>
              <input name="curRemarks" type="text" placeholder="curRemarks" class="form-control" /></td> 
