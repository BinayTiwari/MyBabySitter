    ...
    <!-- Section: inner-header -->
       <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h1 class="mt-0 line-height-1 text-center text-uppercase mb-10 text-black-333">Admin  <span class="text-theme-color-2"> Users List</span></h1>
         </div>
      </div>
     <!-- Section: Blog -->
...
<form id="job_apply_form" name="job_apply_form" action="includes/RUN PAGE" method="post" enctype="multipart/form-data">
 <!-- START Search-->
    <div class="row text-center">              
          ...
          <div class="col-sm-6">
<label>Search By: name, lastname, email, mobile  </label>
<input class="form-control" type="text" id="formGroupInputLarge" placeholder="Large input">
        </div>
 
              
  <!-- START admin DATES filters-->
             <div class="col-sm-6">
               <div class="form-group">
    
    <!-- Datepicker Daterange Markup -->
 <div class="col-md-6">
           <div id="example-daterange text-center">
...
<!-- END admin DATES filters-->
 
        
</div>
 <!-- END admin filters first raw-->
        
 
 <!-- START admin filters secound raw-->
 <!-- START admin COMBOS filters-->
...
<!-- END admin COMBOS filters-->
 
 
 <!-- START admin filters third raw-->
<!-- START admin BUTTONS filters-->
     <div class="row text-center">              

        <div class="col-sm-3">
           <div class="form-group mt-20">
            <label> Log Contain <%=23%>-Records</label> <!-- counted number of current records with filter-->
...
<!-- END pagination -->
  ...
  <div data-example-id="simple-responsive-table" class="bs-example"><div class="table-responsive"> 
	  <table class="table table-bordered"> 
          ...
          <thead> 
		  <tr> <th>id<i class="fa fa-fw fa-sort"></i></th><th>Join dateTime<i class="fa fa-fw fa-sort"></i></th> <th>name+last<i class="fa fa-fw fa-sort"></i></th> <th>image</th> <th>Type<i class="fa fa-fw fa-sort"></i></th> <th>Area<i class="fa fa-fw fa-sort"></i></th> <th>City<i class="fa fa-fw fa-sort"></i></th> <th>entPhoneMobile</th><th>Job Info</th><th>City</th> </tr> </thead> <tbody> 
...
<img src="PhotoGivNid/2/2.jpg" width="35px" alt="userName"  id="topimg" class="pt-5 " data-toggle="tooltip" data-placement="bottom" title="userName" /></td> <td>Giver</td> <td>center</td> <td>tel Aviv</td> <td>03-6546545</td><td>Job Info</td><td>03-6546545</td> </tr> 
